...
--
-- Host: localhost:3306
-- Generation Time: Nov 07, 2021 at 05:08 AM
...
(1, 'Arin', 'Aihara', 'snipahz808@gmail.com', '8082501938', 'arin', 'koji'),
...
(1, 'test', '2021-11-10', 3, 'photo.jpg', 'Hawaii', 'Diving trip', 500.00);
...
--
ALTER TABLE `vacations`
  MODIFY `vacationId` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
